...
for %%a in (%absorptions%) do (
    ...
    --graph-data C:\Users\tsvdh\CodeProjects\VSCode\PbrtScenes\bunny-cloud\absorption\graphs\bunny-cloud_absorption%%a.txt ^
    --outfile C:\Users\tsvdh\OneDrive\Documenten\thesis\results\bunny-cloud_absorption\graph\bunny-cloud_graph_absorption-%%a.exr
)
